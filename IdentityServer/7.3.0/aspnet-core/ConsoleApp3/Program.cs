...
class Program
{
    ...
    {
        var disco = await new HttpClient().GetDiscoveryDocumentAsync("https://localhost:44312");
    ...
    private static async Task GetUsersListAsync(string accessToken)
    {
        ...
        var response = await client.GetAsync("https://localhost:44312/api/services/app/user/GetAll");
