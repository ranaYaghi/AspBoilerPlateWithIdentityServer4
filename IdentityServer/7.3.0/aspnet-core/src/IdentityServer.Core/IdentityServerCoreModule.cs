...
namespace IdentityServer
{
    ...
    public class IdentityServerCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Settings.SettingEncryptionConfiguration.DefaultPassPhrase = IdentityServerConsts.DefaultPassPhrase;
            SimpleStringCipher.DefaultPassPhrase = IdentityServerConsts.DefaultPassPhrase;
        }
