...
namespace IdentityServer.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class IdentityServerRepositoryBase<TEntity> : IdentityServerRepositoryBase<TEntity, int>, IRepository<TEntity>
